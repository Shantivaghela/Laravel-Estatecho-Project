            ...
            <div class="col-lg-12 col-12">
                            <div class="pb-5 mb-5">
                                <div class="section-title-wrap mb-4">
                                    <h4 class="section-title">Your listed property</h4>
                                </div>
                            </div>
            </div>
                ...
                @if (Session::has('success'))
                    ...
                    <div class="">
                                ...
                                <div class="d-flex flex-column ms-auto">
                                    <a href="/userdash/{{$req->id}}/listedit/" class="badge ms-auto">
                                        <i class="bi bi-pencil"></i>
                                        
                                    </a>
                                    <form action="/userdash/{{$req->id}}/buydelete/" method="POST" enctype="multipart/form-data" class="d-inline float-md-right">
                                        @csrf
